...
# ext_modules=[
#         Extension("resources",
#             ["computation.pyx","simulation.pyx",
#              "mle_estimation.pyx","nonparam_estimation.pyx","goodness_of_fit.pyx",
#              "impact_profile.pyx","minimisation_algo.pyx"],
#             libraries=["m"],
...
# scripts = ["computation.pyx","simulation.pyx",
#              "mle_estimation.pyx","nonparam_estimation.pyx","goodness_of_fit.pyx",
#              "impact_profile.pyx","minimisation_algo.pyx"]
...
#         Extension( 
#             "modelling",
#             sources=["model.pyx","lob_model.pyx"],
#             libraries=["m"],
#             extra_compile_args=["-O3","-ffast-math","-march=native"]
#             )
# ]
...
# scripts = ["model.pyx","lob_model.pyx"]
