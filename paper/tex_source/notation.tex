...
\newcommand{\sdHawkesPair}{(\multiCountingProc,\stateVariable)}
...
\newcommand{\subscriptdotse}{_{::e}}
\newcommand{\subscriptdotseone}{_{::\eone}}
\newcommand{\stateSpace}{\mathcal{S}}
\newcommand{\deflationarySpace}{\stateSpace^{-}}
\newcommand{\weakDeflSpace}{\stateSpace^{o,-}}
\newcommand{\weakDeflCompensator}{\compensator^{o,-}}
\newcommand{\weakDeflIntensity}{\intensity[]^{o,-}}
\newcommand{\inflationarySpace}{\stateSpace^{+}}
\newcommand{\weakInflSpace}{\stateSpace^{o,+}}
\newcommand{\intensityDeflationary}{\intensity[]^{-}}
\newcommand{\intensityInflationary}{\intensity[]^{+}}
\newcommand{\Nminus}{\countingProc[]^{-}}
\newcommand{\Nplus}{\countingProc[]^{+}}
\newcommand{\weakDeflPP}{\countingProc[]^{o,-}}
\newcommand{\stateVariable}{X}
\newcommand{\transProb}{\phi}
\newcommand{\lplus}{\ell_{+}}
\newcommand{\lminus}{\ell_{-}}
\newcommand{\leplus}{\ell_{e,+}}
\newcommand{\leminus}{\ell_{e,-}}
\newcommand{\ESSE}{S}
\newcommand{\ESSEone}{S^{(1)}}
\newcommand{\ESSEtwo}{S^{(2)}}
\newcommand{\ESSEthree}{S^{(3)}}
\newcommand{\directImpact}{\text{Dir}}
\newcommand{\indirectImpact}{\text{Indir}}
\newcommand{\transientImpact}{\text{Tra}}
\newcommand{\liquidatorSigmaAlgebra}{\sigmaAlgebraG_{0}}
\newcommand{\impactProfile}{\mathtt{imp}}
\newcommand{\initialTime}{t_{0}}
\newcommand{\terminationTime}{\tau}
\newcommand{\metaorderSize}{Q_{0}}
\newcommand{\WHconvkernel}{K}
\newcommand{\subscriptepsye}{_{\epsilon, y, e}}
\newcommand{\subscriptellu}{_{\ell,u}}
