...
#jobid_pm=$(qsub -l walltime=05:50:00 -l select=1:ncpus=8:mem=4gb:mpiprocs=1:ompthreads=8 -N "impact-pm" -J 0-5 -v "$input" -W depend=afterok:$jobid_r wrapper_submission.sh)
