...
class PerformanceMeasure:
    ...
    def target_loglikelihood(self, int event_type=0, use_prange=False, draw_graph=False,print_res = False):
        ...
        if draw_graph:
            config=Config(grouped=True)
            graphviz=GraphvizOutput(output_file='graph{}_'.format(e)+'.png')
