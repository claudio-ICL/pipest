...
#     exit()
    ...
    EstimProc=mle_estim.EstimProcedure(
        d_E, d_S,
    ...
    "Set the estimation"    
    EstimProc.set_estimation_of_hawkes_param(
        time_start, time_end,
...
#     exit()
    ...
    "Launch estimation"
    run_time = -time.time()
    EstimProc.launch_estimation_of_hawkes_param(e=0)
    run_time+=time.time()
    EstimProc.store_runtime(run_time)
#     model.mle_estim.create_goodness_of_fit()

                           
                           
if __name__=="__main__":
    print("I am executing 'test_mle_estim_2.py'")
